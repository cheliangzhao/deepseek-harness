 ...
 * the REAL shipped bundle layers (dsh-base + dsh-web-app + device automation resolved from the
...
describe('the shipped shell composition (real bundle layers)', () => {
  ...
  // resolve from the REAL Web profile Bundle packages through it, so this

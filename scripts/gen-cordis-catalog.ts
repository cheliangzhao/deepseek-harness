...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  deviceAutomation: 'device-automation.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  detailsPanels: 'client-side interface-typed details-column registry — packages/client/ui-conversation/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  DeviceAutomationProvider: '../../packages/device/device-automation-runtime/README.md',
  DeviceAutomationProviderName: '../../packages/device/device-automation-runtime/README.md',

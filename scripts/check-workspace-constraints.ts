...
/** External package scope published from the maintainer fork. */
const externalPublishedRepositoryUrl = 'git+https://github.com/cheliangzhao/deepseek-harness.git'
...
function checkWorkspace({ dir, manifest }: WorkspaceManifest): string[] {
  ...
  if (isPublicLandlockPackage) {
    ...
    const expectedRepositoryUrl = manifest.name?.startsWith('@fadinglight/') === true
      ? externalPublishedRepositoryUrl

...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/device/device-automation': { kind: 'indirect', reason: 'The Bundle contributes a preset whose own plugins register every model-facing effect.' },
  ...
  'packages/client/ui-device-automation': { kind: 'none', reason: 'Browser-side file and device presentation; registers nothing model-facing.' },
  ...
  'packages/device/device-automation-runtime': { kind: 'none', reason: 'Host-side device and file gateway; registers nothing model-facing.' },
  'packages/device/device-automation-harmonyos': { kind: 'none', reason: 'HarmonyOS device provider; registers nothing model-facing.' },

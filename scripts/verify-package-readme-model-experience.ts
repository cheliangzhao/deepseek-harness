...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-device-preview': { kind: 'none', reason: 'Browser-side device presentation and control; registers nothing model-facing.' },
  ...
  'packages/harmony/screen-preview': { kind: 'none', reason: 'The browser device provider registers no model-facing content.' },

...
| [`harmony/`](harmony/README.zh.md) | 通过 DevEco CLI 工具实现的 HarmonyOS 自动化 | 产品：稳定 API |
| [`device/`](device/README.zh.md) | 跨平台设备自动化运行时、Provider、Bundle 与浏览器 Consumer | 产品：稳定 API |

...
- **An open details column keeps its 300px minimum during concession** — the center may shrink below its preferred minimum on narrow viewports; consumers must not read the stored details width as the rendered width while concession is active.

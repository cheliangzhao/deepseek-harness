...
| [device-automation.md](device-automation.md) | the cross-platform device automation registry, Provider contract, trusted browser operations, and workspace file access |
